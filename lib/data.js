...
export const initialTeamMembers = [
  ...
  },
  {
    id: 4,
    name: "Kimagna Camara",
    role: "Responsable Logistique & SI",
    title: "Responsable Logistique & Services Informatiques",
    photo: "/img/team/kimagna-camara.jpg",
    quote: "La maîtrise logistique et la numérisation des processus garantissent la fluidité de nos chantiers.",
  ...
  },
  {
    ...
    quote: "La conformité juridique et réglementaire est le pilier de tous nos contrats et marchés.",
  ...
  },
  {
    ...
    role: "Ingénieur BTP",
    title: "Ingénieur Suivi & Conduite de Travaux",
    photo: null,
    quote: "Le suivi quotidien du terrain est indispensable pour garantir la conformité et la qualité d'exécution.",
    bio: "Conduite de travaux sur le terrain, suivi des plannings d'exécution et contrôle qualité des ouvrages.",
    skills: ["Conduite de Travaux", "Suivi de Chantier", "Contrôle Qualité", "Béton Armé"]
  },
  {
    id: 7,
    name: "Aminata Diallo",
