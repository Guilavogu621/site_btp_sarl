...
export const initialEquipments = [
  {
    id: 1,
    title: "Pelle Hydraulique Caterpillar CAT 320 GC",
    slug: "pelle-hydraulique-caterpillar-cat-320-gc",
    ...
    condition: "Neuf",
    brand: "Caterpillar",
    model: "CAT 320 GC (22 Tonnes)",
    specs: "Moteur CAT C4.4 ACERT 146 HP, Profondeur d'excavation 6.72m, Capacité godet 1.0 m³, Climatisation & Caméra de recul.",
  ...
  {
    id: 2,
    title: "Groupe Électrogène Insonorisé Cummins 150 kVA",
    slug: "groupe-electrogene-cummins-150-kva",
    category: "Groupe électrogène",
    type: "both",
    price_sale: "85 000 000 GNF",
    price_rent: "1 800 000 GNF / Jour",
    condition: "Neuf",
    brand: "Cummins",
    model: "C150D5 (Silent Container)",
    specs: "Moteur 6BTA5.9-G2, Réservoir 350L (Autonomie 14h), Démarrage automatique ATS & Régulateur AVR.",
    image: "/img/services/suivi-chantier.webp",
    is_available: true,
  ...
  {
    id: 3,
    title: "Système de Coffrage Métallique & Échafaudage (500 m²)",
    slug: "echafaudage-coffrage-multidirectionnel-500m2",
    category: "Coffrage & Échafaudage",
    type: "rent",
    price_sale: null,
    price_rent: "450 000 GNF / Jour",
    condition: "Excellent état",
    brand: "Layher",
    model: "Multidirectionnel Acier Galvanisé",
    specs: "Pack complet 500 m², Planchers aluminium antidérapants, Moises, Garde-corps & Vérins de réglage.",
  ...
  {
    id: 4,
    title: "Camion Benne 6x4 Sinotruk Howo 20m³",
    slug: "camion-benne-sinotruk-howo-6x4-20m3",
    category: "Transport",
    type: "sale",
    price_sale: "210 000 000 GNF",
    price_rent: null,
    condition: "Occasion certifiée",
    brand: "Sinotruk HOWO",
    model: "371 HP 6x4 Heavy Duty",
    specs: "Capacité benne 20m³, Moteur WD615.49 Euro II, Boîte HW19710 (10 vitesses), Châssis renforcé BTP.",
    image: "/img/equipments/camion-howo.jpg",
    is_available: true,
    created_at: "2024-06-12"
  },
  {
    id: 5,
    title: "Bétonnière Autochargeuse Fiori DB X350 (3.5 m³)",
    slug: "betonniere-autochargeuse-fiori-db-x350",
    category: "Outillage",
    type: "both",
    price_sale: "115 000 000 GNF",
    price_rent: "2 500 000 GNF / Jour",
    condition: "Excellent état",
    brand: "Fiori DB",
    model: "DB X350 4x4",
    specs: "Production 3.5 m³ par malaxage, Benne de chargement articulée, Cabine panoramique & Pesage électronique intellimix.",
