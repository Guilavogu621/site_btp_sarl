...
export async function createArticle(articleData) {
  if (supabase) {
    try {
      // On ne transmet à Supabase que les colonnes existantes dans la table articles.
      // Les champs utilitaires comme `slug` sont conservés localement mais pas envoyés en DB.
      const { slug: _slug, id: _id, ...supabasePayload } = articleData;
